...
import { lc_listArticles, lc_isLocked } from '@/lib/localCache'
...
export default function Articles() {
  ...
  // 🔒 compute front-end quota lock (free = 1/month, pro = 15/day)
  const lockState = useMemo(() => lc_isLocked(!!isPro), [isPro])
  ...
  // Auto-open newest when appropriate
  useEffect(() => {
  ...
  function handleNewArticle() {
    if (lockState.locked) {
      toast.error(
        `You're at your limit (${lockState.limit}/${lockState.window === 'day' ? 'today' : 'this month'}).`
      )
      return
    }
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            title={lockState.locked ? 'Quota reached' : 'Generate a new article'}
